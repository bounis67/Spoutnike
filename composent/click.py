...
def verifier_clic(x, y, debut_x, debut_y, taille_carre, taille_grille):
    ...
    if debut_grille_x < x < fin_grille_x and debut_grille_y < y < fin_grille_y:
        print(f"Souris cliquée aux coordonnées ({x}, {y}) à l'intérieur de la grille.")
        ...
        position_x_carre = (((position_x_clic * taille_carre)) + debut_grille_x)
        position_y_carre = (((position_y_clic * taille_carre)) + debut_grille_y)
        print("position_x_carre", position_x_carre, "position_y_carre", position_y_carre)
        ...
        print(f"Souris cliquée aux coordonnées ({x}, {y}) à l'extérieur de la grille.")
